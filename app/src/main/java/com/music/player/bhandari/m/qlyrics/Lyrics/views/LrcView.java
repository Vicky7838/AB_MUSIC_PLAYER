...
package com.music.player.bhandari.m.qlyrics.Lyrics.views;
...
public class LrcView extends View {
    ...
    private void initViews(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs,
                R.styleable.Lrc);
        mTextSize = ta.getDimension(R.styleable.Lrc_textSizeLyric, 50.0f);
        ...
        mNormalPaint.setTypeface(FontFactory.getFont());
        mNormalPaint.setColor(normalTextColor);

        mCurrentPaint.setTextSize(mTextSize);
        mCurrentPaint.setTypeface(FontFactory.getFont());
